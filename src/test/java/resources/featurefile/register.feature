Feature: Registration Functionality
  ...
  Scenario: I should create new account successfully with valid information
    ...
    And     I enter lastname "john"
    And     I enter date of birthday "26"
    And     I enter date of birthmonth "July"
    And     I enter date of birthyear "1998"
    And     I enter emailaddress "john@gmail.com"
    And     I enter password for register "john12345"
    And     I enter confirm password "john12345"
