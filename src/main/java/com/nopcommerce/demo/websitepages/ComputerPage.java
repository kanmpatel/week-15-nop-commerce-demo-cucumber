package com.nopcommerce.demo.websitepages;
...
public class ComputerPage extends Utilites {

    public static final Logger log = LogManager.getLogger(ComputerPage.class);
    public ComputerPage() {
